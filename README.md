...
```
## 📝 Podsumowanie
Zrealizowany projekt to nowoczesna, rozproszona aplikacja do web scrapingu, umożliwiająca automatyczne pobieranie danych z witryny Books to Scrape. System został zaprojektowany z naciskiem na modularność, wydajność i skalowalność. Dzięki wykorzystaniu kontenerów Docker oraz połączeń w Kubernetes, możliwe jest łatwe wdrażanie i skalowanie aplikacji.
